  ...
  return (
    <MainStyle className={`${isMenuActive ? "mobile" : ""}`}>
      ...
      <div>
        <h3>Visão</h3>
        <p>
          Ser uma equipe competitiva que atue de forma abrangente no seguimento
          de sindico profissional e gestão condominial, através de um serviço de
          qualidade, buscando atender as necessidades e expectativas dos nossos
          clientes.
        </p>
      </div>
      <div>
        <h3>Valor</h3>
        <p>
          Compromisso e responsabilidade, competência e soluções criativas, com
          foco na satisfação dos nossos clientes e ética nas relações.
        </p>
      </div>
    </MainStyle>
  );
